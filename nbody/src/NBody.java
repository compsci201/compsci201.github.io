...
public class NBody {
	 ...
	 * t = totalTime
	 */
	public double[][] nBodyPositions(Scanner info, int totalTime, 
			int timeStep){
		//TODO: Complete this method
		double[][] output = new double[2][n]; //Replace n with the number of 
		//bodies, read from the file
		output[0] = xpos; //xpos should be the array of final x-positions
		output[1] = ypos; //ypos should be the array of final y-positions
		return output;
	}
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		myNBody.nBodyPositions(info, time, dt);
		StdDraw.clear();
		StdAudio.close();
	}
}
