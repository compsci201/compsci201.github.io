...
public interface IDnaStrand {
	 ...
	 * method will be called by the <code>append</code> method with an
	 * IDNAStrand parameter if the <code>IDnaStrand</code> passed to that other
	 * append method isn't the same class as the strand being appended to.
	 * 
	 * @param dna
