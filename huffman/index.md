...
- [TestHuff.java]() - Simple JUnit tests to check for correctness
...
You only need to implement and submit a single file for Huffman: `HuffProcessor.java`.  In order to get full credit, you should thoroughly read and reference this assignment write-up in addition to the [walk-through](http://compsci.capture.duke.edu/Panopto/Pages/Viewer.aspx?id=7ceae602-871d-4b22-a1f1-8dbf98e10815)/[walk-through notes]() and follow these steps.
